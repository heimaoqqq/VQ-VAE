...
def parse_args():
    ...
    parser.add_argument("--batch_size", type=int, default=2, help="批次大小，适配16GB显存建议为2-4")
    ...
    parser.add_argument("--gradient_accumulation_steps", type=int, default=4, help="梯度累积步数，用于模拟更大批次")
