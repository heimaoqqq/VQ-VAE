...
def parse_args():
    ...
    parser.add_argument("--batch_size", type=int, default=8, help="批次大小，纯自注意力下显存占用更低，可以增加到8-16")
    parser.add_argument("--num_samples", type=int, default=16, help="生成样本数量")
    parser.add_argument("--image_size", type=int, default=256, help="图像尺寸")
    parser.add_argument("--epochs", type=int, default=200, help="训练轮数，大模型需要更长训练时间")
    parser.add_argument("--lr", type=float, default=1e-4, help="学习率，标准扩散模型通常使用1e-4")
    ...
    parser.add_argument("--logging_steps", type=int, default=50, help="日志间隔步数")
